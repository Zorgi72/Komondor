...
use super::auth::{
    dispatch_cancel_login, dispatch_login, dispatch_loginzyth, dispatch_logout,
    dispatch_logoutzyth, dispatch_submit_auth_code,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::LogoutZyth => dispatch_logoutzyth(app),
        ...
        Action::LoginZyth => dispatch_loginzyth(app),
