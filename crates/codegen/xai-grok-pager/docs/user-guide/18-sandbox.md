...
for the life of the session**. When you resume it (`zyth --resume <id>`,
`zyth --continue`, or `zyth -r`), Grok restores that same profile automatically —
